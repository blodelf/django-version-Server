...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0027_delete_users_history'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='users_history',
            fields=[
                ('id', models.ForeignKey(db_column='user_id', default=0, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='main.users_all')),
